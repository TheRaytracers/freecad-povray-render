...
FreeCAD, like other CAD software, won't tell you whether an object is a solid or a mesh. And for most of the cases it is not that important to know. But if you do a high resolution rendering of a highly polished sphere, for example you won't like to see a lot of faces. So for a realistic rendering our advice is, to use CSG as long as you can and only switch to meshes, if there is no other possibility.
